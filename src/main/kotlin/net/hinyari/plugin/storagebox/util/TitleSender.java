 ...
 * @author  HimaJyun
 * @see     [https://gist.github.com/HimaJyun/ceea12423f5504ffcf3e5c580e0014b6]
 */
public class TitleSender
{
    ...
    public TitleSender()
    {
        try {
            ...
            if (tmpEnumTitleAction != null && tmpPacketPlayout != null && tmpChatMessageType != null) {
                // 必要なclassを取得します。
                ...
                constructorActionBar = Objects.requireNonNull(getNMSClass("PacketPlayOutChat")).getConstructor(tmpIchatBase, tmpChatMessageType);
                enumActionBar = tmpChatMessageType.getField("GAME_INFO").get(null);
                methodChatSerializer = Objects.requireNonNull(getNMSClass("IChatBaseComponent$ChatSerializer")).getMethod("a", String.class);
                methodSendpacket = Objects.requireNonNull(getNMSClass("PlayerConnection")).getMethod("sendPacket", getNMSClass("Packet"));
                try {
                ...
                fieldConnection = Objects.requireNonNull(getNMSClass("EntityPlayer")).getField("playerConnection");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
